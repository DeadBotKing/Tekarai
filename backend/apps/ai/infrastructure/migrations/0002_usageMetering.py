    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenantId", "windowStart"], name="aiQuotaCoun_tenantI_2761a7_idx"
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenantId", "createdAt"], name="aiUsageAtte_tenantI_7eeb61_idx"
                    ),
                    models.Index(
                        fields=["tenantId", "idempotencyKey"], name="aiUsageAtte_tenantI_60013c_idx"
                    ),
                ],
