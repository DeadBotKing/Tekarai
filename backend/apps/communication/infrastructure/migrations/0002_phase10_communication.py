    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("meetingId", "userId", "capability"), name="UQ_Cap_meeting_user_cap"
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("messageId", "revisionNumber"), name="UQ_Revision_message_number"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("transcriptId", "sequence"), name="UQ_Segment_transcript_seq"
                    )
                ],
            },
        ),
