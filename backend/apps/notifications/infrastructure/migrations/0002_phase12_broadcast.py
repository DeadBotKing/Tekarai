    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["notificationId", "recipientId", "channel"], name="IX_Dlv12_nrc"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("notificationId", "recipientId", "channel"), name="UQ_Dlv12_triple"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipientState",
                    models.CharField(db_index=True, default="UNREAD", max_length=12),
                ),
