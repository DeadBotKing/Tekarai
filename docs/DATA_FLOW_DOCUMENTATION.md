# Meryx --- Data Flow Documentation

## 1. Purpose

This document defines how information moves through Meryx.
...
Meryx backend handles signaling and business state. It is not the media
transport itself.
