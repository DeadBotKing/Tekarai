...
1.  Read `TekaraiMasterImplementationSpecification.md`.
2.  Read `ArchitectureHandoff.md`.
3.  Read `DataFlowDocumentation.md`.
4.  Read this document.
5.  Read `ExecutionGuide.md`.
