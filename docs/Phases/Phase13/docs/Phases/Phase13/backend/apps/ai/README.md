...
The application service accepts `AIProviderPort` and never imports a provider SDK. Real Provider Adapters, Registry, Routing, Retry, and persistence remain in later Phase 13 sub-phases.
